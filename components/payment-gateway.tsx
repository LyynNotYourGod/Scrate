...
export default function PaymentGateway() {
  ...
  const handleDownloadQRIS = async () => {
    ...
    try {
      // Fetch the image
      const response = await fetch("https://files.catbox.moe/kdlbi0.png")
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-3xl md:text-4xl font-bold text-center mb-2 font-poppins">Payment Lyyn Store</h1>
        ...
        <div className="flex flex-col">
          ...
          >
            <div className="space-y-4">
              ...
              <Button
                onClick={() => handleCopy("0882010414726", "dana")}
                className={cn(
        ...
        <div className="flex flex-col">
          ...
          >
            <div className="space-y-4">
              ...
              <Button
                onClick={() => handleCopy("0882010414726", "gopay")}
                className={cn(
                  "w-full relative overflow-hidden group",
                  "bg-white dark:bg-gray-800 border-0",
                  "shadow-[6px_6px_12px_#d1d1d1,-6px_-6px_12px_#ffffff] dark:shadow-[6px_6px_12px_#131313,-6px_-6px_12px_#272727]",
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center py-2">
                <div className="bg-white p-4 rounded-lg w-48 h-48 flex items-center justify-center shadow-md overflow-hidden">
                  <img
                    src="https://files.catbox.moe/kdlbi0.png"
                    alt="QRIS Code"
